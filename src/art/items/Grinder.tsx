...
export function Grinder({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      ...
      {/* metal collar */}
      <path
        d="M 47 41.6 L 73.6 41 L 72.4 49 L 48.4 49.6 Z"
        fill="var(--kraft-deep)"
        stroke="var(--ink)"
        strokeWidth="2.6"
        strokeLinejoin="round"
      ...
      <path
        d="M 44 58 Q 56 56 64 58.4 Q 74 60.6 78 58.6"
        fill="none"
        stroke="var(--roast)"
        strokeWidth="1.7"
        opacity="0.55"
